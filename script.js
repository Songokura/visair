...
"m.desc":"Visair.kz - 2018 жылдан бері Астанадағы виза орталығы. АҚШ, Еуропа (Шенген), Ұлыбритания, Канада, Жапония визалары. 2ГИС-те 118 пікір бойынша 5.0 рейтинг. Қызмет құны 40 000 ₸-ден.",
...
"h.lead":"Сауалнама, құжаттар, тапсыруға жазылу және нәтижеге дейін қолдау. Қызмет құны - 40 000 ₸-ден. <a href=\"https://2gis.kz/astana/geo/70000001061028917\" target=\"_blank\" rel=\"noopener\">2ГИС-те 118 пікір бойынша 5.0</a> рейтинг.",
...
"p.lbl":"Қызмет құны",
"d1.k":"Шенген · Еуропа · Италия","d1.h":"Еуропаға виза",
"d1.l":"Италия, Испания, Франция, Германия және басқа елдерге шенген. Сауалнама, сақтандыру, брондау және виза орталығына жазылу - біздің мойнымызда.",
"d1.cta":"Шенгенге жазылу","d1.alt":"Күн батардағы Рим Колизейі - Италия мен Шенген елдеріне виза",
"d2.k":"АҚШ · B1/B2","d2.h":"АҚШ визасы",
"d2.l":"DS-160 сауалнамасы, сұхбатқа жазылу және оған дайындық. Бас тарту пайызы төмен, жылдам тапсыру.",
"d2.cta":"АҚШ визасына жазылу","d2.alt":"Күн батардағы Манхэттен - АҚШ визасы",
"d3.k":"Ұлыбритания · Visitor","d3.h":"Ұлыбритания визасы",
"d3.l":"Онлайн-сауалнама, табыс пен елмен байланысты растау, биометрияға жазылу.",
"d3.cta":"Ұлыбритания визасына жазылу","d3.alt":"Лондондағы Биг-Бен мен Вестминстер сарайы - Ұлыбритания визасы",
"d4.k":"Канада · Visitor visa","d4.h":"Канада визасы",
"d4.l":"Онлайн тапсыру, сапар мақсатын растау, биометрияға жазылу.",
"d4.cta":"Канада визасына жазылу","d4.alt":"Биіктен көрінген Торонто мен CN мұнарасы - Канада визасы",
"d5.k":"Жапония · Корея · Қытай · Австралия","d5.h":"Жапония және Азия визалары",
"d5.l":"Жапония - 40 000 ₸. Корея, Қытай және Австралия - құны сұраныс бойынша.",
"d5.cta":"Жапония визасына жазылу","d5.alt":"Күн батардағы Токио мұнарасы - Жапония визасы",

"c.k":"Бағалар","c.h":"Бағыттар бойынша қызмет құны",
"c.l":"Бұл орталық жұмысының бағасы. Консулдық және сервистік алымдар бөлек төленеді.",
...
"w.k":"Қалай жұмыс істейміз","w.h":"Өтінімнен визалы паспортқа дейін төрт қадам",
...
"r.k":"Пікірлер","r.h":"2ГИС-те 118 пікір бойынша 5.0 рейтинг",
...
"r.gn":"2ГИС-те 118 пікір","r.gl":"Пікірлерді оқу",
...
"f.note":"Батырманы басқанда дайын хабарламасы бар WhatsApp ашылады. Деректеріңізді сақтамаймыз.",
...
"k.foot":"Виза орталығы · Астана · 2018 жылдан",
"k.disc":"Виза беру туралы шешімді консулдық қабылдайды. Біз құжаттарды формальды себептермен бас тарту болмайтындай етіп дайындаймыз және нәтижеге дейін қолдау көрсетеміз.",
"dock.call":"Қоңырау"
};
...
var WAT = {
  ru:{
    "wa.main":"Здравствуйте! Хочу оформить визу. Подскажите, пожалуйста, сроки, стоимость и список документов.",
    "wa.shengen":"Здравствуйте! Хочу оформить шенгенскую визу (Европа). Подскажите сроки, стоимость и список документов.",
    "wa.usa":"Здравствуйте! Хочу оформить визу в США. Подскажите сроки, стоимость и список документов.",
    "wa.uk":"Здравствуйте! Хочу оформить визу в Великобританию. Подскажите сроки, стоимость и список документов.",
    "wa.canada":"Здравствуйте! Хочу оформить визу в Канаду. Подскажите сроки, стоимость и список документов.",
    "wa.japan":"Здравствуйте! Хочу оформить визу в Японию (или другую страну Азии). Подскажите сроки, стоимость и список документов.",
    "wa.price":"Здравствуйте! Подскажите, пожалуйста, стоимость оформления визы и что входит в услугу."
  },
  kk:{
    "wa.main":"Сәлеметсіз бе! Виза рәсімдегім келеді. Мерзімін, құнын және құжаттар тізімін айтып жіберіңізші.",
    "wa.shengen":"Сәлеметсіз бе! Шенген визасын (Еуропа) рәсімдегім келеді. Мерзімін, құнын және құжаттар тізімін айтыңызшы.",
    "wa.usa":"Сәлеметсіз бе! АҚШ визасын рәсімдегім келеді. Мерзімін, құнын және құжаттар тізімін айтыңызшы.",
    "wa.uk":"Сәлеметсіз бе! Ұлыбритания визасын рәсімдегім келеді. Мерзімін, құнын және құжаттар тізімін айтыңызшы.",
    "wa.canada":"Сәлеметсіз бе! Канада визасын рәсімдегім келеді. Мерзімін, құнын және құжаттар тізімін айтыңызшы.",
    "wa.japan":"Сәлеметсіз бе! Жапония (немесе басқа Азия елі) визасын рәсімдегім келеді. Мерзімін, құнын және құжаттар тізімін айтыңызшы.",
    "wa.price":"Сәлеметсіз бе! Виза рәсімдеу құнын және қызметке не кіретінін айтып жіберіңізші."
  }
};
var UI = {
  ru:{ msg:"Здравствуйте! Меня зовут {n}. Хочу оформить визу: {d}. Телефон: {p}." },
  kk:{ msg:"Сәлеметсіз бе! Менің атым {n}. Виза рәсімдегім келеді: {d}. Телефон: {p}." }
};
